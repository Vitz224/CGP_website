...
<section class = "contact-section">
      <div class = "contact-bg">
        ...
        <p class = "text">Parking is the action of moving a vehicle into a place in a car park or by the side of the road where it can be left.</p>
      </div>
      ...
      <div class = "contact-body">
        <div class = "contact-info">
          ...
          <div>
            ...
            <span>E-mail</span>
            <span class = "text">cruiserpark@gmail.com</span>
          </div>
          <div>
          ...
          <div>
            ...
            <span class = "text">Monday - Sunday (12:00 AM to 11:00 PM)</span>
          </div>
        </div>
